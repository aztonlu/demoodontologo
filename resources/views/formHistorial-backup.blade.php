...
<body id="app-layout" onload="checkCookies()">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                          ...
                          <div class="col-sm-12">
                            <div class="col-sm-6">
                              ...
                              <div class="form-group{{ $errors->has('dni') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-8">
                                      ...
                                      <input id="idHistorial" type="hidden" name="idHistorial" value="">
                                      @if ($errors->has('dni'))
                                          <span class="help-block">
                              ...
                              <div class="form-group{{ $errors->has('fechaHistorial') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-8">
                                      <input id="" type="date" class="form-control" name="fechaHistorial" value="<?php echo date('Y-m-d'); ?>" disabled>
                                      <input id="fechaHistorial" type="date" class="form-control" name="fechaHistorial" value="<?php echo date('Y-m-d'); ?>">
                            ...
                            <div class="col-sm-6">
                              ...
                              <div class="form-group{{ $errors->has('diagnostico') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-10">
                                      <textarea class="form-control" rows="4" id="diagnostico" name="diagnostico"></textarea>
                      ...
                      <center><button type="button" class="btn btn-primary" onclick="funcionForm2()">
                          <i class="fa fa-btn fa-user"></i> Guardar y Salir
                      </button>
                      <button type="button" class="btn btn-primary" onclick="generaryrecetar()">
                          <i class="fa fa-btn fa-user"></i> Guardar y generar Receta
                      </button>
    ...
    <script>
      ...
      function generaryrecetar()
      {
        document.getElementById('status').value = "receta";
        document.getElementById('form2').submit();
      }
