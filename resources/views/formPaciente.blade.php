            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="registroPaciente">
                            {{ csrf_field() }}
                            ...
                            <div class="col-sm-12">
                              ...
                              <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('antecedentes') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="form-control" rows="8" id="antecedentes" name="antecedentes" value="{{ old('antecedentes') }}"></textarea>
